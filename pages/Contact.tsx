...
import { Mail, Mic, HelpCircle } from 'lucide-react';
  ...
  return (
    <div className="w-full pt-32 pb-20 bg-cream min-h-screen">
      ...
      <div className="max-w-4xl mx-auto px-6 mb-16 text-center">
        <Reveal>
          <h1 className="font-display text-5xl md:text-6xl text-charcoal mb-4">Conectemos</h1>
          <p className="font-body text-xl text-warm-grey">
            Estoy aquí para servir. Elige la opción que mejor se adapte a tu necesidad.
          </p>
        </Reveal>
      </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              <div className="space-y-8">
                 <h2 className="font-display text-3xl text-charcoal">
                   {activeTab === 'general' && "Consultas Generales"}
                   {activeTab === 'speaking' && "Contratar Conferencia"}
                   {activeTab === 'media' && "Kit de Prensa"}
                 </h2>
                 <p className="font-body text-warm-grey">
                   {activeTab === 'general' && "¿Tienes preguntas sobre el Reto Padres 3.0 o quieres saludar? Completa el formulario."}
                   {activeTab === 'speaking' && "Para verificar disponibilidad para tu evento, por favor provee detalles sobre la fecha, ubicación y audiencia."}
                   {activeTab === 'media' && "Para entrevistas, podcasts o citas en artículos, contacta directamente a mi equipo de PR."}
                 </p>
              ...
              <form className="space-y-6">
                 <div>
                   <label className="block font-sans text-xs font-bold uppercase tracking-wider text-charcoal mb-2">Nombre Completo</label>
                 ...
                 <div>
                   <label className="block font-sans text-xs font-bold uppercase tracking-wider text-charcoal mb-2">Email</label>
                 ...
                 {activeTab === 'speaking' && (
                   <div>
                     <label className="block font-sans text-xs font-bold uppercase tracking-wider text-charcoal mb-2">Fecha del Evento</label>
                 ...
                 <div>
                   <label className="block font-sans text-xs font-bold uppercase tracking-wider text-charcoal mb-2">Mensaje</label>
