...
const MentoriaUtahPeru: React.FC = () => {
      ...
      <div style={styles.container}>
        ...
        <section style={{
          ...
          <div style={{
            ...
            <p className="animate-fade-4 hero-subtitle" style={{
              ...
              <span style={{ color: '#ffffff', fontWeight: 400 }}>está más cerca de lo que crees.</span>
            </p>
        ...
        <section style={{
          ...
          <div style={{ ...styles.maxWidth, position: 'relative', zIndex: 10 }}>
            ...
            <div style={styles.grid2}>
              {[
                { icon: '💰', stat: '40%', label: 'más baratas', title: 'Universidades accesibles', desc: 'Opciones reales para familias latinoamericanas. Sin endeudarte de por vida.', accent: '#d4af37' },
        ...
        <section style={{
          ...
          <div style={{ ...styles.maxWidth, position: 'relative', zIndex: 10 }}>
            ...
            <div style={styles.grid2}>
              {[
                { icon: '👨‍👩‍👧‍👦', text: 'Estás en Perú o Latinoamérica y quieres lo mejor para tus hijos' },
                { icon: '🌎', text: 'Tus hijos sueñan con una educación internacional de calidad' },
              ...
              <div style={{
                ...
                <div>
                  ...
                  <h2 style={{
                    ...
                    Ayudando a familias latinoamericanas a alcanzar el sueño americano
                  </h2>
                  ...
                  <p style={{
                    ...
                    a familias de Perú y toda Latinoamérica en su camino hacia una mejor educación. Con más de 15 años
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              ...
              <p style={{ fontSize: '24px', fontWeight: 600, color: '#d4af37' }}>S/ 50</p>
            </div>
            <button
              onClick={handleCTA}
              style={{
...
export default MentoriaUtahPeru;
