        ...
        <section style={{
          ...
          <div style={{ ...styles.maxWidth, position: 'relative', zIndex: 10 }}>
            ...
            <div style={styles.grid2}>
              {[
                { icon: '💰', stat: '40%', label: 'más baratas', title: 'Universidades accesibles', desc: 'Opciones reales para familias latinoamericanas. Sin endeudarte de por vida.', accent: '#FFB81D' },
