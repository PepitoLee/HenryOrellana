...
const WHATSAPP_MESSAGE = encodeURIComponent('Hola Henry, vengo del LIVE de TikTok y quiero aprovechar la oferta de $30 USD para la mentoría migratoria.');
...
const MentoriaUtahPromo: React.FC = () => {
  ...
  const razones = [
    ...
    },
    {
      ...
      desc: 'Solo $30 por consulta en esta oferta exclusiva.',
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Simplemente haz clic en cualquier botón de esta página para contactarme por WhatsApp. Menciona que vienes del LIVE de TikTok para obtener el precio especial de $30 USD.',
    },
  ];
  ...
  return (
    <>
      <Helmet>
        <html lang="es" />
        <title>🔥 OFERTA LIVE TIKTOK | Mentoría Migratoria $30 USD - Henry Orellana</title>
        <meta name="description" content="OFERTA EXCLUSIVA del LIVE de TikTok. Mentoría migratoria por solo $30 USD (precio regular $50). NO soy abogado - Soy tu MENTOR." />
        <meta property="og:title" content="🔥 OFERTA LIVE - Mentoría Migratoria $30 USD" />
        <meta property="og:description" content="Precio exclusivo para asistentes del LIVE de TikTok. Ahorra $20 USD." />
      ...
      <div style={styles.container}>
        ...
        <div className="promo-banner" style={{
          ...
          top: 0,
          zIndex: 100,
          background: `linear-gradient(135deg, ${colors.promo} 0%, #C0392B 100%)`,
          padding: '16px 24px',
          textAlign: 'center',
            ...
            <div style={{
              ...
              <div>
                ...
                <p style={{
                  ...
                  <span style={{ textDecoration: 'line-through', opacity: 0.7 }}>$50 USD</span>
                  {' → '}
                  <span style={{
                    fontWeight: 800,
                  ...
                  <span style={{ marginLeft: '8px', background: colors.accent, color: colors.primary, padding: '2px 8px', borderRadius: '4px', fontWeight: 700, fontSize: '12px' }}>
                    AHORRAS $20
                  </span>
                </p>
              </div>
            ...
            <div style={{
              ...
              <div>
                ...
                <p className="animate-fade-3 hero-subtitle" style={{
                  ...
                  <span style={{ color: colors.white, fontWeight: 500 }}>
                    ¡Aprovecha el precio especial del LIVE!
                  </span>
                </p>
                ...
                <div className="animate-fade-5" style={{
                  ...
                  <span style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
                    <svg style={{ width: '16px', height: '16px', color: colors.promo }} fill="currentColor" viewBox="0 0 20 20">
                      <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                    </svg>
                    OFERTA LIMITADA
                  </span>
              ...
              <div className="animate-fade-3" style={{
                ...
                <p style={{
                  ...
                  USD · Pago único · <span style={{ color: colors.accent, fontWeight: 600 }}>¡Ahorras $20!</span>
                </p>
            ...
            <Reveal>
              ...
              <div style={{
                ...
                <p style={{
                  ...
                  <span style={{ textDecoration: 'line-through' }}>$50</span> → <span style={{ fontWeight: 800, fontSize: '20px' }}>$30 USD</span> · Ahorras $20
                </p>
              </div>
              ...
              <p style={{
                ...
                Aprovecha este precio exclusivo del LIVE. Por solo $30 USD, tendrás orientación personalizada de alguien que entiende tu situación.
              </p>
              ...
              <p style={{
                ...
                ⚡ Respuesta en menos de 24 horas · 100% en español · Menciona el LIVE
              </p>
            </Reveal>
          </div>
        </section>
        ...
        <footer style={{
          ...
          <div style={styles.maxWidth}>
            ...
            <p style={{
              ...
              Mentoría Migratoria · Oferta LIVE TikTok
            </p>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div>
              <p style={{ fontSize: '12px', color: colors.gray }}>🔴 OFERTA LIVE</p>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <span style={{ fontSize: '14px', color: colors.gray, textDecoration: 'line-through' }}>$50</span>
                <span style={{ fontSize: '24px', fontWeight: 700, color: colors.success }}>$30 USD</span>
              </div>
            </div>
            <button
              onClick={handleCTA}
...
export default MentoriaUtahPromo;
